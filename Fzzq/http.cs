...
namespace Http
{
    ...
    class Requests
    {
        ...
        public Response Get(string Url, string postDataStr, ref CookieContainer cookie, string Referer = "")
        {
            ...
            request.Method = "GET";
            request.ContentType = "text/html;charset=UTF-8";//gb2312,UTF-8
        ...
        // Post方法
        public Response Post(string Url, string postDataStr, ref CookieContainer cookie, string Referer = "")
        {
    ...
    class SafeCode
    {
        ...
        public string read2dig(Image image)
        {
            ...
            bmp = ClearNoise(bmp);
            bmp.Save("./img/去噪图.bmp", System.Drawing.Imaging.ImageFormat.Bmp);
        ...
        {
            Bitmap bmpOld = (Bitmap)image;
            Bitmap bmp = bmpOld.Clone(new Rectangle(0, 0, bmpOld.Width, bmpOld.Height), PixelFormat.Format24bppRgb);
        ...
        private Bitmap ClearNoise(Image image)
        {
            Bitmap bmpOld = (Bitmap)image;
            Bitmap bmp = bmpOld.Clone(new Rectangle(0, 0, bmpOld.Width, bmpOld.Height), PixelFormat.Format24bppRgb);
            int x, y;
